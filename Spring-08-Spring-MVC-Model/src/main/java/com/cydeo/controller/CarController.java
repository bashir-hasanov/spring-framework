...
public class CarController {
    ...
    @RequestMapping("/info")  //localhost:8080/car/info?make=Honda
                                 //localhost:8080/car/info?make=Honda&year=2022
    public String carInfo(@RequestParam String make, @RequestParam Integer year, Model model) {  //Query param
    ...
    public String getCarInfo(@PathVariable String make, @PathVariable Integer year, Model model) {  //Path param
        model.addAttribute("make", make);
        model.addAttribute("year", year);
        return "car/car-info";
