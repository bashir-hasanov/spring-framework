...
public interface CinemaRepository extends JpaRepository<Cinema, Long> {
    ...
    List<Cinema> findTop3BySponsoredNameContainingOrderBySponsoredNameDesc(String sponsoredName);
