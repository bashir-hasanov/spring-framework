...
public interface AccountRepository extends JpaRepository<Account, Long> {
    ...
    List<Account> findByStateIs(String state);
    ...
    List<Account> getAccountsByAgeLower(@Param("age")Integer age);
    ...
    List<Account> getAccountsBySearch(@Param("pattern") String pattern);
